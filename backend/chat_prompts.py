...
class ChatPromptsAndSuggestions:
    ...
    def __init__(self):
        self.suggested_questions = {
            ...
            "ne": {
                "greeting": [
                    "गर्भावस्थामा के खानु उपयुक्त हुन्छ?",
                    "मितली सामान्य हुन्छ?",
                    "प्रसवका संकेत के हुन्छन्?",
                ],
                "nutrition": [
                    "कुन खानामा फलाम हुन्छ?",
                    "क्याफिन सुरक्षित छ?",
                    "प्रेनेटल भिटामिन लिनु पर्छ?",
                ],
                "symptoms": [
        ...
        self.question_types_guide = {
            ...
            "ne": {
                "title": "मदत गर्न सक्ने प्रश्नका प्रकार",
                "categories": [
                    {
                        "emoji": "🍽️",
                        "title": "पोषण",
                        "description": "स्वास्थ्यकर खाना, परहेज गर्नुपर्ने खाना, भिटामिन, र आहार सम्बन्धी प्रश्न",
                        "examples": ["के खानु उपयुक्त हुन्छ?", "क्याफिन सुरक्षित छ?", "फलाम सप्लिमेन्ट आवश्यक छ?"]
                    },
                    {
                        "emoji": "🤰",
    ...
    def get_welcome_message(self, language: str = "en") -> str:
        ...
        if str(language).lower().startswith("ne"):
            return "नमस्ते! 👋 म गर्भावस्था र मातृ स्वास्थ्य सम्बन्धी तपाईंका प्रश्नहरूको उत्तर दिन यहाँ छु। कृपया कुनै प्रश्न सोध्नुहोस् वा मसँग कुरा गर्नुहोस्।"
